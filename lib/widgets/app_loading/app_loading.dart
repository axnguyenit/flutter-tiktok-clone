...
class _AppLoadingState extends State<AppLoading>
  ...
  late Sink<bool> _innerBallSink;

  late Stream<bool> _innerBallStream;
  ...
  void initState() {
    ...
    _innerBallSink = _innerBallStreamController.sink;
    _innerBallStream = _innerBallStreamController.stream;
  }
...
class AppLoadingDelegate extends FlowDelegate {
  ...
  @override
  bool shouldRepaint(AppLoadingDelegate oldDelegate) {
    return false;
  }
}
